...
# 2. specify bios_code and bios_vars variable, you may want to store uefi vars file to keep your boot settings
...
# 6. add path to a file which should act as storage for -drive
# 7. don't use win7, it doesn't support pure uefi (wihtout csm)
